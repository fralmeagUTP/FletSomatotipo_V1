...
- [x] Ejecutar la suite completa de regresión (244 pruebas y 7 subpruebas).
- [x] Impedir que una ventana Web estrecha active composiciones exclusivas del APK Android.
